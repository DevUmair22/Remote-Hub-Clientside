			...
			array.push(
				...
				>
					...
					<div className="w-full flex ">
						<div className="mb-6 w-2/4 mx-auto px-2  flex flex-col items-start">
							{' '}
							<label className="block mx-2 text-md  font-medium text-primary ">
								Project Title
							</label>
						...
						<div className="mb-6 w-2/4 mx-auto flex flex-col px-2 items-start">
							{' '}
							<label className="block  text-md  font-medium text-primary ">
								Project Description
							</label>
					...
					<div className="w-full flex  ">
						<div className="mb-6 w-2/4 mx-auto px-2 flex-col  flex items-start">
							{' '}
							<label className="block mx-2 text-md  font-medium text-primary ">
